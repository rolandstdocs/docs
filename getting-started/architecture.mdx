...
![Screenshot2025 07 23at11 45 02AM Pn](/images/Screenshot2025-07-23at11.45.02AM.png)

```
graph TD
    A[MCP Client] -->|WebSocket Connection| B[MCP Server]
    B -->|Approval Request| C[Approver Client]
    C -->|Approval/Rejection| B
    B -->|Code Execution| D[Code Execution Environment<br/>GitHub Codespace]
    D -->|Results| B
    B -->|Response| A
