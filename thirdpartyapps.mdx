...
Follow these steps to securely connect the apps you would like to use within Claude to Keyboard.

<Steps>
  <Step title="Navigate to Repository Settings" iconType="regular" stepNumber={1} titleSize="h2">
  ...
  <Step title="Add Repository Secrets" titleSize="h2">
    Click New Repository Secret

    Enter the secret name with KEYBOARD\_ prefix in the following format KEYBOARD_APPNAME_API_KEY (e.g. KEYBOARD_TYPEFORM_API_KEY)
