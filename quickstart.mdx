...
- Claude Desktop, with an account that can add integrations and MCP servers
...
<Steps>
  <Step title="Fork the Codespace repo">
    Fork this [repo](https://github.com/keyboard-dev/codespace-executor).
  </Step>
  <Step title="Generate a GitHub PAT for the Codespace repo">
  ...
  <Step title="Set up with Claude Desktop in Claude Desktop">
  ...
  <Step title="Clone the Approver app">
    Get access to both repos

    [need to ask for help]
  </Step>
  <Step title="Add .env for the desktop app">
